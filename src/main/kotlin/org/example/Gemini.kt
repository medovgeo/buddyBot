...
//        val addition = additions[rnd.nextInt(additions.size)]
        ...
        return "Текст ниже в формате json это переписка друзей в чате. " +
                ...
                "Остроумно и осмысленно ответь на последнее сообщение с $undertone оттенком. " +
                "Можешь использовать слова и фразы других участников из переписки, если они подходят по смыслу." +
